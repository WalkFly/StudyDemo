...
//        System.out.println(clazz.getClassLoader().getClass().getName());
        ...
        Class clazz = classLoader.loadClass("cn.com.soyea.zx.jvm.cheapter1.demo3.User");
        Object obj = clazz.newInstance();
        Method method = clazz.getDeclaredMethod("sout", null);
        method.invoke(obj,null);
        ...
        //D盘创建 cn.com.soyea.zx.cheapter1.demo3 几级目录，将User类的复制类User1.class丢入该目录
        Class clazz1 = classLoader1.loadClass("cn.com.soyea.zx.jvm.cheapter1.demo3.User");
